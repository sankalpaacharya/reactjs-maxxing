...
description: "How React breaks rendering into small interruptible units"
date: "2026-03-25"
topic: "React"
draft: false
---
...
- [Running React on different platforms](https://reactjs-maxxing.vercel.app/blog/running-react-on-different-platform)
...
- [Understanding why react fiber exists](https://reactjs-maxxing.vercel.app/blog/understanding-why-react-fiber-exists)
...
inside that callback is the setCount function. Internally, setCount is just a state dispatcher it tells React, _this fiber has new work that needs to be scheduled._
...
- [How state updates work internally](https://reactjs-maxxing.vercel.app/blog/how-state-updates-work-internally)
