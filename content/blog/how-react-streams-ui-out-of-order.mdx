...
Once `$RC` has a complete pair, the template and the resolved component, it calls `$RV` using `requestAnimationFrame` to do the actual DOM swap.
...
Special thanks to [@render](https://x.com/infinterenders/) for catching few things I missed.